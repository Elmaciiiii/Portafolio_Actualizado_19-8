import { Contador } from "./contador.js"; // Asegúrate de que la ruta es correcta
...
// Guardado de partida
document.querySelectorAll(".agregar, .restar").forEach(boton => boton.addEventListener("click", guardarPartida));
